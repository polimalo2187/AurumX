  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-black md:text-5xl">Retiros pendientes</h1>
      </div>
      <Card>
        <p className="text-zinc-400">Aprobación manual con hash BEP20 o rechazo con nota.</p>
