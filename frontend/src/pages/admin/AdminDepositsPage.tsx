  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-black md:text-5xl">Depósitos</h1>
      </div>
      <Card>
        <p className="text-zinc-400">Verificación automática BSC/BEP20, reintentos y casos en revisión.</p>
