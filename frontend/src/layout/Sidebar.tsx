import { Bell, Factory, Gauge, Gem, Landmark, Megaphone, ReceiptText, TrendingUp, UserRound, WalletCards } from "lucide-react";
...
const items = [
  ...
  { to: "/rewards", label: "Recompensas", icon: TrendingUp },
